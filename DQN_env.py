        ...
        if self.time_step==self.iterations:
            ...
            if display[1] ==1 or display[0] ==1:
                ...
                if self.day<5:
                    ...
                    np.save("result/" + 'baseline1_SOCS_RENDER{}.npy'.format(self.day), SOCS_RENDER)
                # ax1 = ax.twinx()
            ...
            if display[3] == 1 or display[0] == 1:
                ...
                if self.day<8:
                    ...
                    np.save("result/" + 'baseline1_ENERGY_SOLD_RENDER{}.npy'.format(self.day), ENERGY_SOLD_RENDER)
                    np.save("result/" + 'baseline1_ENERGY_BOUGHT_RENDER{}.npy'.format(self.day), ENERGY_BOUGHT_RENDER)
                plt.show()
